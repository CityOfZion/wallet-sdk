...
class BIP39Encoded {
    constructor(options = BIP39DefaultOptions) {
        /**
        ...
        if (options.mnemonic) {
            ...
            //hex
            else if (/^[0-9A-Fa-f]+$/.test(options.mnemonic) &&
    ...
    generateSeed(secret = "") {
        this.secret = secret;
        this.seed = bip39.mnemonicToSeedSync(this.mnemonic.phonetic.join(" "), this.secret);
        return this.seed;
    }
    bin2hex(b) {
...
//# sourceMappingURL=BIP39Encoded.js.map